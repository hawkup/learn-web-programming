...
HelloServiceClient.prototype.hello = function(callback) {
...
HelloServiceClient.prototype.send_hello = function() {
...
HelloServiceProcessor.prototype.process_hello = function(seqid, input, output) {
  ...
  args.read(input);
  input.readMessageEnd();
  if (this._handler.hello.length === 0) {
    Q.fcall(this._handler.hello)
    ...
    this._handler.hello(function (err, result) {
      if (err == null) {
